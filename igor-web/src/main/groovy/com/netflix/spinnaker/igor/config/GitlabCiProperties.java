...
@Validated
public class GitlabCiProperties implements BuildMasterProperties<GitlabCiProperties.GitlabCiHost> {
    ...
    public static class GitlabCiHost implements BuildMasterProperties.Host {
        @NotEmpty
        private String name;
        @NotEmpty
