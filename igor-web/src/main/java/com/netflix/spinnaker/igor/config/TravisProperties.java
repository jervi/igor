...
public class TravisProperties implements BuildMasterProperties<TravisProperties.TravisHost> {
    ...
    public static class TravisHost implements BuildMasterProperties.Host {
        @NotEmpty
        private String name;
        @NotEmpty
